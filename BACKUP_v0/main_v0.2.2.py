...
for line in source_file:
    ...
    if progress_tick[1] > progress_tick[0]:
        ...
        print('Loading source file... '+str(progress_tick[0])+'%' +
              ' ['+str(word_counter)+'/'+str(dictionary['count'])+']', end='\r')
        # set next milestone
        progress_tick[0] += 1
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        word_obj.contained_sequences[seq_key] = dictionary['letters'+str(seq_len)][seq_key]
...
print('Loading source file... 100% - '+str(dictionary['count'])+' words loaded.')
